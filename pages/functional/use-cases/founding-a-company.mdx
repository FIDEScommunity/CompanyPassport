...
attorney Authorised Director Attestations are within the scope of the current Founding a Company use case.
...
sequenceDiagram
    ...
    coc ->> coc: Verify PID registered as Authorised Director with full power of attorney in Holding A
    coc ->> holding_a_wallet: Issue Chamber of Commerce Registration Attestation
    Note right of coc: TODO:<br/>The Chamber of Commerce should also issue an "Authorised Director"<br/>Attestation with full power of attorney to the Person A Personal Wallet
...
sequenceDiagram
    ...
    person_a_wallet -->> notary: Present PID and Holding A Authorised Director Attestations
    ...
    Note right of coc: TODO:<br/>The Chamber of Commerce probably also needs to verify the <br/>Authorised Director Attestation of Holding A and the PID of Person A<br/>before issuing the Chamber of Commerce Registration Attestation
