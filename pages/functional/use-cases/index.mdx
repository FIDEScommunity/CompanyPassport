...
| ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [Founding a Company](./use-cases/founding-a-company) | Using EAA’s to digitalize and optimize the process of founding a company.                                                                      |
| Know Your Business (KYB) Onboarding                  | Using EAA’s to avoid duplicating expensive KYB onboarding by financial institutions.                                                           |
...
| Company Certifications                               | Issuing EAA’s for any kind of company certification to offer machine readable proof of these certificates.                                     |
| ESG Reporting                                        | Using EAA’s to issue machine readable ESG reports consisting of the sum of various EAA’s from trusted issuers combined with self issued EAA’s. |
...
| e-Invoicing                                          | Using organizational EAA’s and wallets to manage and discover identifiers and e-Invoicing end points                                           |
