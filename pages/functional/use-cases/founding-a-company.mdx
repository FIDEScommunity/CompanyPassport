...
In the current "Uitreksel" created by the Chamber of Commerce, Authorized Directors are listed directly. For the Company Passport,
an authorized director for a legal entity can get an Authorized Director Attestation issued to their personal wallet.
The Authorized Director Attestation will link to the Chamber of Commerce Number. Only full power of
attorney Authorized Director Attestations are within the scope of the current Founding a Company use case.
