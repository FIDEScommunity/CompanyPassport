...
| Dataspace Onboarding                                 | Using organisational EAA’s for automatically onboarding organizations based on the policies set by the dataspace (or any digital ecosystem).   |
| e-Invoicing                                          | Using organisational EAA’s and wallets to manage and ddiscover identifiers and e-Invoicing end points                                          |
