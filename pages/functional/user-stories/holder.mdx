...
### H.10 Present Wallet Attestation when receiving Attestation

As an Organizational Wallet I want to present a Wallet Attestation when receiving an Attestation, so that the Atttestation Provider can verify the Wallet Provider and assure the Organizational Wallet conforms to the requirements for issuing the Attestation.
