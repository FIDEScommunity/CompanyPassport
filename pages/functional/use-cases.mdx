...
CompanyPassport will start with the initial [use case of “Founding a Company”](./use-case-founding-company.mdx) but several other use cases may be added. Some examples in the table below.
